...
public class KeyHelper{
    ...
    public String getPWDFromSharedPrefs(Context ctx){
        SharedPreferences prefs = ctx.getSharedPreferences(SHARED_PREFENCE_NAME, 0);
        return prefs.getString(SECRET_PASSWORD, null);
    }
    public void storePWDInSharedPrefs(String value,Context ctx){
        SharedPreferences prefs = ctx.getSharedPreferences(SHARED_PREFENCE_NAME, 0);
        SharedPreferences.Editor edit = prefs.edit();
        edit.putString(SECRET_PASSWORD, value);
        edit.apply();
    }
}
